...
const countlessFuneralsForSpring: Lyric = {
    slug: "countless-funerals-for-spring",
    ...
    body: {
        lyrics: `
        there was one more thing i wanted to say to you
...
export default countlessFuneralsForSpring